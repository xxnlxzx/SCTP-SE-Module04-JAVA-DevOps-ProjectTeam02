...
public class BookingController {
    ...
    @GetMapping("")
    public ResponseEntity<ArrayList<Booking>> getAllBookings(@RequestHeader(value = "password") String password,
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Booking> getBooking(@PathVariable Long id, @RequestHeader(value = "password") String password,
            @RequestHeader(value = "user") String user) throws AuthenticationException {
        useridService.verifyPassword(user, password);
